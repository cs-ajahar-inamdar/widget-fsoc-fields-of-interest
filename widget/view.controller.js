...
(function () {
    angular
      .module('cybersponse')
      .controller('fsocFieldsOfInterest100Ctrl', fsocFieldsOfInterest100Ctrl);

    fsocFieldsOfInterest100Ctrl.$inject = ['$scope', '$state', 'Entity', 'FormEntityService', 'Modules', 'viewTemplate', '$rootScope', '$timeout', 'widgetBasePath'];

    function fsocFieldsOfInterest100Ctrl($scope, $state, Entity, FormEntityService, Modules, viewTemplate, $rootScope, $timeout, widgetBasePath) {
